...
export interface WorkspaceAdmissionRecordedV1 { eventType: "WorkspaceAdmissionRecordedV1"; workspaceId: string; proposalDigest: string; decisionEventId: string; quotaId: string; quotaDigest: string; consumed: "yes" | "no" }
...
export function parseDomainEventPayloadV1(value: unknown): DomainEventPayloadV1 {
  ...
  if (h.eventType === "WorkspaceAdmissionRecordedV1") oneOf(r.consumed,["yes","no"],"EVENT_PAYLOAD_INVALID");
