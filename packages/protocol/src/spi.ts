...
export type TransportInspectionV1=
 ...
 |{readonly transport:"unix-socket";readonly localOnly:true;readonly peerVerified:boolean;readonly peerIdentity:string|null;readonly ownerMatchesProcess:boolean;readonly mode:number}
