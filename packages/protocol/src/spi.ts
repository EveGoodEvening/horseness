...
export interface WorkerReturnV1{schemaVersion:"1";binding:BoundAdapterOperationV1;receipt:AttemptReceiptEnvelopeV1;proposal:ProposalEnvelopeV1;publications:readonly {digest:string;kind:"artifact"|"evidence"}[];decisionResume:{proposalId:string;proposalDigest:string;subscriptionId:string;resumeToken:string|null}}
