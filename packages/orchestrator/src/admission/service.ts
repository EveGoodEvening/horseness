...
export class AdmissionService {
  ...
  evaluateAndApply(request: AdmissionRequestV1): AdmissionResultV1 {
    ...
    const state:AdmissionTerminalState=request.action==="reject"&&priorState==="approval_required"?"rejected":request.action==="release"&&priorState==="quarantined"&&delta.outcome==="accepted"?"accepted":evaluation.result;
