...
| C15 | `adapters/pi/**`, root `package.json` (only the `scripts["host:smoke:pi"]` forwarding key; smoke implementation remains adapter-owned), `tests/fixtures/hosts/pi/**`, `docs/integrations/pi.md`, `docs/compatibility.md` |
