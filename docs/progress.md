...
- **Active claims:** C12 (SDK and secure adapter/install SPI), solely claimed from integrated base `BASE_SHA`
...
| C12 | SDK/adapter kit | C11 | in-progress; tracker-only claim from integrated base `BASE_SHA`; C11 final candidate `05c5f4c6`, completion `8987a1af`, and lessons `7defa3f1` recorded; implementation and acceptance not yet completed |
